...
{
    ui->setupUi(this);
    s1=std::shared_ptr<Sensor>(new HallSensor(516,160));
...
void MainWindow::paintEvent(QPaintEvent *event){
    ...
    QPen pen;
    QImage image("C:/Users/Derek/OneDrive/NSE/leerjaar2/object oriented programming 2/Practicum/gebouw/Gebouw.png");
